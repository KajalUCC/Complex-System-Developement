...
<body>
  ...
  <section>
    <left_col>
      ...
      <button type="button" onclick="window.location.href='CSD_Send_Request.php' ">Send New Request</button><br><br>
      <button type="button" onclick="window.location.href='CSD_delete_server.php' ">Delete server</button><br><br>
    </left_col>
    <right_col><h1 style ="text-align:center">New Server</h1>
      <div class="form">
      <form name="add_new_server" style ="text-align:center" action="CSD_server.php">
        <label>Requestor:</label> <input class="1" type="text" name="requestor"><br><br>
        <label>Server Name:</label><input type="text" name="server_name"><br><br>
        <label>Capacity:</label><input type="text" name="capacity"><br><br>
        <label>RAM Size:</label><input type="text" name="RAM"><br><br>
